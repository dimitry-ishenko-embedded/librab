...
void board_init() _sdcccall
{
    ...
    TACSR= TACSRW= TIMERA2_7_INT_DISABLE | TIMERA1_INT_DISABLE | TIMERA_CLOCK_ENABLE;
    TAPR = TAPRW = TIMERA_CLOCK_PERIF_DIV2;
    TACR = TACRW = TIMERA2_7_CLOCK_MAIN | TIMERA_INT_DISABLE;

    ivt_intern_isr(INT_PERIODIC, &isr_periodic);
    GCSR = SPEED_MAIN_CLOCK | PERIODIC_INT_PRIO3;
